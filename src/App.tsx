    ...
    <div className="page-shell">
      <nav className={`nav ${navRaised ? 'nav--scrolled' : ''}`}>
        <div className="brand-mark">
          <span className="brand-title">rinde</span>
        </div>
      ...
      <header className="hero hero--compact">
        <div className="hero-body">
          <div className="hero-content">
            <h1>
              Compara precios, <span>compra inteligente</span> y ahorra en cada compra.
            </h1>
            <p>
              Recopilamos precios de miles de tiendas online para mostrarte dónde comprar más barato. Encuentra las mejores ofertas sin perder tiempo.
            </p>
          ...
          <a 
            href="https://whatsapp.com/channel/0029Vb7FTZkCsU9TOU9hCC25" 
            target="_blank" 
        ...
        <div className="footer-main">
          ...
          <div className="footer-contact">
            <div className="footer-email">
              <span>📧 Contacto:</span>
              <a href="mailto:rindestoremx@gmail.com">rindestoremx@gmail.com</a>
            </div>
            <div className="footer-whatsapp">
              <span>📱 Únete a nuestro canal de WhatsApp:</span>
              <a href="https://whatsapp.com/channel/0029Vb7FTZkCsU9TOU9hCC25" target="_blank" rel="noopener noreferrer">
                <img src="/whatsapp-qr.jpeg" alt="QR Canal de WhatsApp - Rinde Ahorros" className="whatsapp-qr" />
              </a>
            </div>
          </div>
        </div>
